...
# setup_model(outdir,record_dir,'model126_nontsc',params[0],dust_file,plot=True,record=False,\
#     aperture=aperture,idl='model126.dat',radmc=False,tsc=False)
