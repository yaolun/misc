def record_hyperion(dict_params, outdir):
	...
	colhead = ('Model#','age','Cs','Omega0','tstar','R_env_max','theta_cav','rho_cav_center','rho_cav_edge','rstar','M_disk_dot',\
			   'M_disk','beta','h100','rho_cav','d_sub','M_env_dot','R_inf','R_cen','mstar','percentile','absolute','relative','view_angle')

	if not os.path.exists(outdir+'model_list.txt'):
		foo = open(outdir+'model_list.txt','w')
		foo.write('%10s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s \n' % colhead) 
		foo.close()
	...
	foo.write('%10s  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e \n' % output)
