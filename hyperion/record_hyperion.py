def record_hyperion(dict_params, outdir):
	...
	if not os.path.exists(outdir+'model_list.txt'):
		...
		foo.write('%8s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s \n' % colhead) 
		foo.close()
	...
	output = (output,dict_params['M_env_dot'],dict_params['R_cen'],dict_params['R_inf'],dict_params['tstar'],\
			  ...
			  dict_params['percentile'],dict_params['absolute'],dict_params['relative'],dict_params['view_angle'])
	foo.write('%10s  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e \n' % output)
