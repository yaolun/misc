def record_hyperion(dict_params, outdir):
	...
	colhead = ('Model#','M_env_dot','R_cen','R_inf','tstar','R_env_max','theta_cav','rho_cav_center','rho_cav_edge','rstar','M_disk_dot',\
			   'M_disk','beta','h100','rho_cav','d_sub','age','Cs','Omega0','percentile','absolute','relative')

	if not os.path.exists(outdir+'model_list.txt'):
		foo = open(outdir+'model_list.txt','w')
		foo.write('%8s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s  %14s \n' % colhead) 
		foo.close()
	...
	output = (output,dict_params['M_env_dot'],dict_params['R_cen'],dict_params['R_inf'],dict_params['tstar'],\
			  ...
			  dict_params['rho_cav'],dict_params['d_sub'],dict_params['age'],dict_params['Cs'],dict_params['Omega0'],\
			  dict_params['percentile'],dict_params['absolute'],dict_params['relative'])
	foo.write('%10s  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e  %14e \n' % output)
