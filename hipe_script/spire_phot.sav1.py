...
for obsidFTS in Obsid:
    ...
    if (not IS_FINITE(phot_obs[0])) or (phot_obs[0] == 0):
    ...
    for phot_o in phot_obs:
        ...
        # making it applicmarker='+', c='Magenta', s=120, linewidth=2able to fully extended sources with nu F nu=constant spectrum
